//! Lean 4 backend — persistent JSON-RPC server for proof checking.
//!
...
//! has high overhead. LPR uses a persistent JSON-RPC server that stays
//! alive across multiple check_source calls, dramatically reducing latency.
//!
...
//! enabling the refinement loop to generate targeted corrections.
